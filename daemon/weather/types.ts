// Raw JSON from the Davis station API (nested structure)
export interface StationRaw {
  error?: string;
  liveData?: Record<string, unknown>;
  hiLowData?: Record<string, unknown>;
  consoleInfo?: Record<string, unknown>;
  [key: string]: unknown;
}

// Flattened and typed record ready to insert into DB
